...
setwd("G:\\anita\\Austral\\Primer_Anio\\LaboratorioDeImplementacion1\\Practicos" )  #establezco la carpeta donde voy a trabajar
...
pdf(file = "./arbol_canaritos_Sin_Canario.pdf", width=28, height=4)
