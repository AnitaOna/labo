...
PARAM$finalmodel$semilla           <- 308803

PARAM$finalmodel$num_iterations    <-  321
PARAM$finalmodel$learning_rate     <-    0.0511085472343526
PARAM$finalmodel$feature_fraction  <-    0.698104692922835
